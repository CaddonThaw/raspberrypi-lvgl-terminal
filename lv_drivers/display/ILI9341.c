...
void ili9341_init(void)
{
    ...
    digitalWrite(PIN_DC, ILI9341_DATA_MODE); 
    ...
    /* set orientation */
    ili9341_rotate(270, ILI9341_BGR);
...
void ili9341_flush(lv_disp_drv_t * drv, const lv_area_t * area, lv_color_t * color_p)
{
    ...
    ili9341_send_byte(ILI9341_CASET);
    data[0] = act_x1 >> 8;
    data[1] = act_x1;
    data[2] = act_x2 >> 8;
    data[3] = act_x2;
    ...
    /* window vertical */
    digitalWrite(PIN_DC, ILI9341_CMD_MODE);  
    ili9341_send_byte(ILI9341_PASET);
    data[0] = act_y1 >> 8;
    data[1] = act_y1;
    data[2] = act_y2 >> 8;
    data[3] = act_y2;
    ...
    digitalWrite(PIN_DC, ILI9341_CMD_MODE);
    ili9341_send_byte(ILI9341_RAMWR);
